...
var wasmBinaryFile = 'cgltf-sapp.wasm';
...
function sapp_js_hook_beforeunload(){ window.addEventListener('beforeunload', function(_sapp_event) { if (__sapp_html5_get_ask_leave_site() != 0) { _sapp_event.preventDefault(); _sapp_event.returnValue = ' '; } }); }
function sapp_js_focus_textfield(){ document.getElementById("_sokol_app_input_element").focus(); }
function saudio_js_init(sample_rate,num_channels,buffer_size){ Module._saudio_context = null; Module._saudio_node = null; if (typeof AudioContext !== 'undefined') { Module._saudio_context = new AudioContext({ sampleRate: sample_rate, latencyHint: 'interactive', }); console.log('sokol_audio.h: created AudioContext'); } else if (typeof webkitAudioContext !== 'undefined') { Module._saudio_context = new webkitAudioContext({ sampleRate: sample_rate, latencyHint: 'interactive', }); console.log('sokol_audio.h: created webkitAudioContext'); } else { Module._saudio_context = null; console.log('sokol_audio.h: no WebAudio support'); } if (Module._saudio_context) { console.log('sokol_audio.h: sample rate ', Module._saudio_context.sampleRate); Module._saudio_node = Module._saudio_context.createScriptProcessor(buffer_size, 0, num_channels); Module._saudio_node.onaudioprocess = function pump_audio(event) { var num_frames = event.outputBuffer.length; var ptr = __saudio_emsc_pull(num_frames); if (ptr) { var num_channels = event.outputBuffer.numberOfChannels; for (var chn = 0; chn < num_channels; chn++) { var chan = event.outputBuffer.getChannelData(chn); for (var i = 0; i < num_frames; i++) { chan[i] = HEAPF32[(ptr>>2) + ((num_channels*i)+chn)] } } } }; Module._saudio_node.connect(Module._saudio_context.destination); var resume_webaudio = function() { if (Module._saudio_context) { if (Module._saudio_context.state === 'suspended') { Module._saudio_context.resume(); } } }; document.addEventListener('click', resume_webaudio, {once:true}); document.addEventListener('touchstart', resume_webaudio, {once:true}); document.addEventListener('keydown', resume_webaudio, {once:true}); return 1; } else { return 0; } }
function sfetch_js_send_range_request(slot_id,path_cstr,offset,num_bytes,content_length,buf_ptr){ var path_str = UTF8ToString(path_cstr); var req = new XMLHttpRequest(); req.open('GET', path_str); req.responseType = 'arraybuffer'; var need_range_request = !((offset == 0) && (num_bytes == content_length)); if (need_range_request) { req.setRequestHeader('Range', 'bytes='+offset+'-'+(offset+num_bytes)); } req.onreadystatechange = function() { if (this.readyState == this.DONE) { if ((this.status == 206) || ((this.status == 200) && !need_range_request)) { var u8_array = new Uint8Array(req.response); HEAPU8.set(u8_array, buf_ptr); __sfetch_emsc_range_response(slot_id, num_bytes); } else { __sfetch_emsc_failed(slot_id); } } }; req.send(); }
function saudio_js_sample_rate(){ if (Module._saudio_context) { return Module._saudio_context.sampleRate; } else { return 0; } }
function sfetch_js_send_head_request(slot_id,path_cstr){ var path_str = UTF8ToString(path_cstr); var req = new XMLHttpRequest(); req.open('HEAD', path_str); req.onreadystatechange = function() { if (this.readyState == this.DONE) { if (this.status == 200) { var content_length = this.getResponseHeader('Content-Length'); __sfetch_emsc_head_response(slot_id, content_length); } else { __sfetch_emsc_failed(slot_id); } } }; req.send(); }
...
var asmGlobalArg = {};
var asmLibraryArg = { "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "__assert_fail": ___assert_fail, "__setErrNo": ___setErrNo, "__syscall140": ___syscall140, "__syscall146": ___syscall146, "__syscall54": ___syscall54, "__syscall6": ___syscall6, "_computeUnpackAlignedImageSize": __computeUnpackAlignedImageSize, "_fillMouseEventData": __fillMouseEventData, "_findCanvasEventTarget": __findCanvasEventTarget, "_findEventTarget": __findEventTarget, "_glGenObject": __glGenObject, "_heapObjectForWebGLType": __heapObjectForWebGLType, "_registerKeyEventCallback": __registerKeyEventCallback, "_registerMouseEventCallback": __registerMouseEventCallback, "_registerTouchEventCallback": __registerTouchEventCallback, "_registerUiEventCallback": __registerUiEventCallback, "_registerWebGlEventCallback": __registerWebGlEventCallback, "_registerWheelEventCallback": __registerWheelEventCallback, "abort": _abort, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abs": _abs, "emscriptenWebGLGet": emscriptenWebGLGet, "emscriptenWebGLGetTexPixelData": emscriptenWebGLGetTexPixelData, "emscripten_get_device_pixel_ratio": _emscripten_get_device_pixel_ratio, "emscripten_get_element_css_size": _emscripten_get_element_css_size, "emscripten_get_heap_size": _emscripten_get_heap_size, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_realloc_buffer": emscripten_realloc_buffer, "emscripten_request_animation_frame_loop": _emscripten_request_animation_frame_loop, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_set_canvas_element_size": _emscripten_set_canvas_element_size, "emscripten_set_keydown_callback_on_thread": _emscripten_set_keydown_callback_on_thread, "emscripten_set_keypress_callback_on_thread": _emscripten_set_keypress_callback_on_thread, "emscripten_set_keyup_callback_on_thread": _emscripten_set_keyup_callback_on_thread, "emscripten_set_mousedown_callback_on_thread": _emscripten_set_mousedown_callback_on_thread, "emscripten_set_mouseenter_callback_on_thread": _emscripten_set_mouseenter_callback_on_thread, "emscripten_set_mouseleave_callback_on_thread": _emscripten_set_mouseleave_callback_on_thread, "emscripten_set_mousemove_callback_on_thread": _emscripten_set_mousemove_callback_on_thread, "emscripten_set_mouseup_callback_on_thread": _emscripten_set_mouseup_callback_on_thread, "emscripten_set_resize_callback_on_thread": _emscripten_set_resize_callback_on_thread, "emscripten_set_touchcancel_callback_on_thread": _emscripten_set_touchcancel_callback_on_thread, "emscripten_set_touchend_callback_on_thread": _emscripten_set_touchend_callback_on_thread, "emscripten_set_touchmove_callback_on_thread": _emscripten_set_touchmove_callback_on_thread, "emscripten_set_touchstart_callback_on_thread": _emscripten_set_touchstart_callback_on_thread, "emscripten_set_webglcontextlost_callback_on_thread": _emscripten_set_webglcontextlost_callback_on_thread, "emscripten_set_webglcontextrestored_callback_on_thread": _emscripten_set_webglcontextrestored_callback_on_thread, "emscripten_set_wheel_callback_on_thread": _emscripten_set_wheel_callback_on_thread, "emscripten_webgl_create_context": _emscripten_webgl_create_context, "emscripten_webgl_do_create_context": _emscripten_webgl_do_create_context, "emscripten_webgl_init_context_attributes": _emscripten_webgl_init_context_attributes, "emscripten_webgl_make_context_current": _emscripten_webgl_make_context_current, "fabs": _fabs, "floor": _floor, "flush_NO_FILESYSTEM": flush_NO_FILESYSTEM, "glActiveTexture": _glActiveTexture, "glAttachShader": _glAttachShader, "glBindBuffer": _glBindBuffer, "glBindFramebuffer": _glBindFramebuffer, "glBindRenderbuffer": _glBindRenderbuffer, "glBindTexture": _glBindTexture, "glBindVertexArray": _glBindVertexArray, "glBlendColor": _glBlendColor, "glBlendEquationSeparate": _glBlendEquationSeparate, "glBlendFuncSeparate": _glBlendFuncSeparate, "glBlitFramebuffer": _glBlitFramebuffer, "glBufferData": _glBufferData, "glBufferSubData": _glBufferSubData, "glClear": _glClear, "glClearBufferfi": _glClearBufferfi, "glClearBufferfv": _glClearBufferfv, "glClearBufferuiv": _glClearBufferuiv, "glClearColor": _glClearColor, "glClearDepthf": _glClearDepthf, "glClearStencil": _glClearStencil, "glColorMask": _glColorMask, "glCompileShader": _glCompileShader, "glCompressedTexImage2D": _glCompressedTexImage2D, "glCompressedTexImage3D": _glCompressedTexImage3D, "glCreateProgram": _glCreateProgram, "glCreateShader": _glCreateShader, "glCullFace": _glCullFace, "glDeleteBuffers": _glDeleteBuffers, "glDeleteFramebuffers": _glDeleteFramebuffers, "glDeleteProgram": _glDeleteProgram, "glDeleteRenderbuffers": _glDeleteRenderbuffers, "glDeleteShader": _glDeleteShader, "glDeleteTextures": _glDeleteTextures, "glDeleteVertexArrays": _glDeleteVertexArrays, "glDepthFunc": _glDepthFunc, "glDepthMask": _glDepthMask, "glDisable": _glDisable, "glDisableVertexAttribArray": _glDisableVertexAttribArray, "glDrawArrays": _glDrawArrays, "glDrawArraysInstanced": _glDrawArraysInstanced, "glDrawBuffers": _glDrawBuffers, "glDrawElements": _glDrawElements, "glDrawElementsInstanced": _glDrawElementsInstanced, "glEnable": _glEnable, "glEnableVertexAttribArray": _glEnableVertexAttribArray, "glFrontFace": _glFrontFace, "glGenBuffers": _glGenBuffers, "glGenRenderbuffers": _glGenRenderbuffers, "glGenTextures": _glGenTextures, "glGenVertexArrays": _glGenVertexArrays, "glGetAttribLocation": _glGetAttribLocation, "glGetError": _glGetError, "glGetIntegerv": _glGetIntegerv, "glGetProgramInfoLog": _glGetProgramInfoLog, "glGetProgramiv": _glGetProgramiv, "glGetShaderInfoLog": _glGetShaderInfoLog, "glGetShaderiv": _glGetShaderiv, "glGetString": _glGetString, "glGetUniformLocation": _glGetUniformLocation, "glLinkProgram": _glLinkProgram, "glPolygonOffset": _glPolygonOffset, "glReadBuffer": _glReadBuffer, "glRenderbufferStorage": _glRenderbufferStorage, "glRenderbufferStorageMultisample": _glRenderbufferStorageMultisample, "glScissor": _glScissor, "glShaderSource": _glShaderSource, "glStencilFunc": _glStencilFunc, "glStencilFuncSeparate": _glStencilFuncSeparate, "glStencilMask": _glStencilMask, "glStencilOp": _glStencilOp, "glStencilOpSeparate": _glStencilOpSeparate, "glTexImage2D": _glTexImage2D, "glTexImage3D": _glTexImage3D, "glTexParameterf": _glTexParameterf, "glTexParameteri": _glTexParameteri, "glUniform1fv": _glUniform1fv, "glUniform1i": _glUniform1i, "glUniform2fv": _glUniform2fv, "glUniform3fv": _glUniform3fv, "glUniform4fv": _glUniform4fv, "glUniformMatrix4fv": _glUniformMatrix4fv, "glUseProgram": _glUseProgram, "glVertexAttribDivisor": _glVertexAttribDivisor, "glVertexAttribPointer": _glVertexAttribPointer, "glViewport": _glViewport, "memcpy": _memcpy, "memset": _memset, "sapp_js_create_textfield": sapp_js_create_textfield, "sapp_js_focus_textfield": sapp_js_focus_textfield, "sapp_js_hook_beforeunload": sapp_js_hook_beforeunload, "sapp_js_unfocus_textfield": sapp_js_unfocus_textfield, "saudio_js_buffer_frames": saudio_js_buffer_frames, "saudio_js_init": saudio_js_init, "saudio_js_sample_rate": saudio_js_sample_rate, "sbrk": _sbrk, "setTempRet0": _setTempRet0, "sfetch_js_send_head_request": sfetch_js_send_head_request, "sfetch_js_send_range_request": sfetch_js_send_range_request, "stm_js_perfnow": stm_js_perfnow, "stringToNewUTF8": stringToNewUTF8 };
...
var real___sapp_emsc_notify_keyboard_hidden = asm["_sapp_emsc_notify_keyboard_hidden"];
asm["_sapp_emsc_notify_keyboard_hidden"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___sapp_emsc_notify_keyboard_hidden.apply(null, arguments);
};

var real___sapp_html5_get_ask_leave_site = asm["_sapp_html5_get_ask_leave_site"];
asm["_sapp_html5_get_ask_leave_site"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___sapp_html5_get_ask_leave_site.apply(null, arguments);
};
...
var real___saudio_emsc_pull = asm["_saudio_emsc_pull"];
asm["_saudio_emsc_pull"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___saudio_emsc_pull.apply(null, arguments);
};

var real___sfetch_emsc_head_response = asm["_sfetch_emsc_head_response"];
asm["_sfetch_emsc_head_response"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___sfetch_emsc_head_response.apply(null, arguments);
};

var real___sfetch_emsc_range_response = asm["_sfetch_emsc_range_response"];
asm["_sfetch_emsc_range_response"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___sfetch_emsc_range_response.apply(null, arguments);
};

var real___sfetch_emsc_failed = asm["_sfetch_emsc_failed"];
asm["_sfetch_emsc_failed"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___sfetch_emsc_failed.apply(null, arguments);
};
...
var __sapp_emsc_notify_keyboard_hidden = Module["__sapp_emsc_notify_keyboard_hidden"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_sapp_emsc_notify_keyboard_hidden"].apply(null, arguments)
};

var __sapp_html5_get_ask_leave_site = Module["__sapp_html5_get_ask_leave_site"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_sapp_html5_get_ask_leave_site"].apply(null, arguments)
};
...
var __saudio_emsc_pull = Module["__saudio_emsc_pull"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_saudio_emsc_pull"].apply(null, arguments)
};

var __sfetch_emsc_head_response = Module["__sfetch_emsc_head_response"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_sfetch_emsc_head_response"].apply(null, arguments)
};

var __sfetch_emsc_range_response = Module["__sfetch_emsc_range_response"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_sfetch_emsc_range_response"].apply(null, arguments)
};

var __sfetch_emsc_failed = Module["__sfetch_emsc_failed"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_sfetch_emsc_failed"].apply(null, arguments)
};
